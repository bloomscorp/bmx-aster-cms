...
export class AsterFormData {
    ...
    public static _category: AsterFormInput<Product, AsterFormSelectOption> =
    ...
    public static _collection: AsterFormInput<
        Product,
        AsterFormSelectOption
    ...
    public static _heroImage: AsterFormInput<Product, AsterFormImageItem> =
    ...
    public static _galleryImages: AsterFormInput<Product, AsterFormImageItem> =
    ...
    public static _tags: AsterFormInput<Product, AsterFormChipValue> =
